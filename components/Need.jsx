...
function Need() {
  return (
    <div className={styles.needDiv} id="needDiv">
      <div className={styles.needInfoDiv}>
        ...
        <br />
        <p className={styles.needInfo}>
          The initiative aims to provide a stimulus to develop financial
          instincts among <b> young minds</b> through{' '}
        ...
        <p className={styles.needInfo}>
          ...
          a need for every individual and a <b> finance & investments app</b>{' '}
